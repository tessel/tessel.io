...
$url = [uri]'https://s3.amazonaws.com/builds.tessel.io/cli/tessel-cli-current.tar.gz'

$webclient = New-Object System.Net.WebClient
$webclient.DownloadFile($url, $tarpath)

npm install -g --no-registry --loglevel=info --ignore-scripts .\tessel-cli-current.tar.gz 
cd "$(npm -g prefix)\node_modules\tessel"
npm rebuild
